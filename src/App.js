...
import { faBars, faQuestion, faCog, faBell, faSignOutAlt, faTh } from '@fortawesome/free-solid-svg-icons';
...
library.add(faBars, faQuestion, faCog, faBell, faSignOutAlt, faTh);
